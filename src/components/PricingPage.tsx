      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-6 max-w-7xl mx-auto">
          ...
          <Card className="p-8 hover:shadow-2xl transition-all border-2 border-primary bg-gradient-to-br from-primary/5 to-accent/5 relative overflow-hidden">
            <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-gradient-to-r from-amber-500 via-yellow-500 to-amber-500 text-white px-6 py-2 rounded-full text-sm font-black shadow-2xl border-2 border-white animate-pulse">
              ⭐ ВЫГОДНЕЕ ВСЕГО ⭐
            </div>
